...
public class AdManager {
    ...
    public static void loadInterAd(Context context) {
        AdRequest adRequest = new AdRequest.Builder().build();
        com.google.android.gms.ads.interstitial.InterstitialAd.load(context,context.getString(R.string.interstitial_ad), adRequest, new InterstitialAdLoadCallback() {
            @Override
...
//        if (Utils.isNetworkAvailable(activity)) {
        if (activity.getResources().getString(R.string.max_banner) != null) {
...
//                if (Utils.isNetworkAvailable(activity)) {
                if (activity.getResources().getString(R.string.max_interstitial) != null) {
